function AutoCorrReslt = PC_spatial_autocorrelation(pc_score,pc_gene_coeffs,surrogates)
...
for i = 1:Ngenes
gene_corr_surr_pc(:,i) = corr(GeneData_norm(:,i),surrogates, ...
            'rows','pairwise','type','pearson');
end

gene_corr_pc = corr(pc_score,GeneData_norm, ...
            'rows','pairwise','type','pearson');
