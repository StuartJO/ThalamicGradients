function plot_cell_enrichment(RplOutput)
...
cell_enrich_table = readtable('cell_enrichment.csv');
...
neuron_enrich_table = readtable('neuron_enrichment.csv');
...
subClust_enrich_table = readtable('subcluster_enrichment.csv');
...
exportgraphics(gcf,'./figure_outputs/Fig2.png','Resolution',300)

if RplOutput
 
delete CellEnrichmentCombined.xlsx

writetable(EnrichTable,'CellEnrichmentCombined.xlsx','WriteMode','overwrite','Sheet','CellClassEnrichment')

writetable(NeuronSubtypeEnrichTable,'CellEnrichmentCombined.xlsx','WriteMode','Append','Sheet','NeuronSubtypeEnrichment')

writetable(SubclusterEnrichTable,'CellEnrichmentCombined.xlsx','WriteMode','Append','Sheet','NeuronSubclusterEnrichment')
