function PlotThalGradient2(GRAD_DATA,voxel_seeds,grad_cmap,TITLE,thr)
...
189,0,38;...
128,0,38]./255;
axes_slices = axes('Position',[-.05 .15 .5 .7]);
...
189,0,38;...
128,0,38]./255;
axes_slices = axes('Position',[-.1 .57 .6 .5]);
...
c.Position = [0.45,0.638095238095239,0.526785714285714,0.066666666666666];

annotation(gcf,'textbox',...
    [0.430357142857142,0.754761904761905,0.557142857142857,0.238095238095242],...
    'VerticalAlignment','middle',...
    'String',TITLE,...
    'HorizontalAlignment','center',...
    'FontSize',18,...
