...
%print(['./OHBM2022_figs/PCA_',data_type_savename{j},'_THAL_PC',num2str(g),'.png'],'-dpng','-r300')
PlotThalGradient3(pc_thal,seed_voxel_coords,turbo(256),['Thalamic seed PC',num2str(g),' score'],2.1)
print(['./OHBM2022_figs/Thalamus_PC1.png'],'-dpng','-r300')
...
SPATIAL_DIR = {'Medial-Lateral','Anterior-posterior','Dorsal-ventral'};
    ...
    print(['./OHBM2022_figs/PC1_medlat_corr.png'],'-dpng','-r300')
...
print(['./OHBM2022_figs/Cortical_PC',num2str(i),'.png'],'-dpng','-r300')
...
set(gca,'FontSize',24)
%ylim([0 10])
print(['./OHBM2022_figs/Enrichment_PC1.png'],'-dpng','-r300')
end
