...
% CellClassAxesPos = [0.1885    0.4787    0.2105    0.4795];
% NeuronClassAxesPos = [0.1885    0.1100    0.2105    0.2389];
% NeuronSubtypeAxesPos = [0.5307    0.1308    0.1693    0.8150];
...
% annotation('textbox',[0 Pos(2)+Pos(4)-.1 .1 .1],'String','a','FontSize',32,'EdgeColor','none')
    ...
    annotYpos = find_point_on_line(axis_pos(2),axis_pos(2)+axis_pos(4),.835);
    %[axis_pos(1)-.01 annotYpos axis_pos(3).*.1 axis_pos(2)+axis_pos(4)-annotYpos]
    
    aPanelLoc = [axis_pos(1) annotYpos axis_pos(3).*.1 .1];
...
% annotation('textbox',[0.075 Pos(2)+Pos(4)-.1 .1 .1],'String','b','FontSize',32,'EdgeColor','none')
    ...
    annotation('textbox',[axis_pos(1) annotYpos axis_pos(3).*.1 axis_pos(2)+axis_pos(4)-annotYpos],'String','b','FontSize',32,'EdgeColor','none')
...
%     annotation('textbox',[axis_pos(1)-.01 annotYpos axis_pos(3).*.1 .17],'String','c','FontSize',32,'EdgeColor','none')
    ...
    annotation('textbox',[axis_pos(1) aPanelLoc(2) axis_pos(3).*.1 aPanelLoc(4)],'String','c','FontSize',32,'EdgeColor','none')
...
TSNE_plots_width = (.9999-TSNE_plots_xpos_neg)/2;
...
t = text(mean([new_xmin new_xmax]),text_y,ClusterName{i},'FontSize',20,'HorizontalAlignment','center');
    ...
    axis_pos = get(gca,'OuterPosition');
    annotation('textbox',[axis_pos(1)+.015 aPanelLoc(2) axis_pos(3).*.1 aPanelLoc(4)],'String','d','FontSize',32,'EdgeColor','none')
end
