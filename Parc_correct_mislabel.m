...
% This issue is caused by Freesurfer not properly indetifying the cortical
...
% labelled as being on the left and vice-versa. As a results ROIs can cross
...
data_mask = niftiread(Ribbon);
data = niftiread(Parcellation);
hdr2 = niftiinfo(Parcellation);
...
% increases in radius around the voxel
r = 1;
...
niftiwrite(Combined_corrected,Output,hdr2)